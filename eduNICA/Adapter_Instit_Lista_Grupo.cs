...
namespace eduNICA
{
    ...
    public class Adapter_Instit_Lista_Grupo : BaseAdapter
    {
        Activity context;//definimos el origen del listview
        List<grupos_grados> lista1;//para vinculamos listview

        public Adapter_Instit_Lista_Grupo(Activity context)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Resource.Id.Titulo).Text = item.Grupo;
