...
namespace eduNICA
{
    public class Fragment_Docent_Asistencia_Estudiantes : Fragment
    {
        ...
        public override async void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            vlista = View.FindViewById<ListView>(Resource.Id.listView_ver_asistencia);//vinculamos al listview del layout
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return inflater.Inflate(Resource.Layout.Docent_Asistencia_Ver, container, false);
        }
    }
}